...
.sheet .r-head{display:flex;align-items:center;gap:18px;border-bottom:3px solid #3a4a23;padding-bottom:16px;margin-bottom:18px}
.sheet .r-photo{width:74px;height:74px;border-radius:50%;object-fit:cover;border:2px solid #ece9fb;flex-shrink:0}
.sheet .r-photo.ph{background:#3a4a23;color:#fff;display:grid;place-items:center;font-weight:700;font-size:26px}
.sheet h1{font-size:25px;color:#1d211a;line-height:1.1}
.sheet .r-role{color:#3a4a23;font-weight:700;font-size:14px;margin-top:3px}
.sheet .r-contact{font-size:11.5px;color:#5a6275;margin-top:7px;display:flex;gap:12px;flex-wrap:wrap}
.sheet h2{font-size:13px;text-transform:uppercase;letter-spacing:1px;color:#1d211a;margin:18px 0 8px;border-bottom:1px solid #e6e9f2;padding-bottom:5px}
...
.sheet .chip{font-size:11.5px;font-weight:600;background:#e7efd9;color:#3a4a23;border:1px solid #cfe0b6;padding:4px 11px;border-radius:20px}
.sheet .proj-item{margin-bottom:9px}
.sheet .proj-item b{font-size:12.5px;color:#1d211a}
.sheet .proj-item small{color:#3a4a23}
