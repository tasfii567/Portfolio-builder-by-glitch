...
<style>
.suggest{background:linear-gradient(120deg,#241b4a,#5a2f4d);border:1px solid var(--line);border-radius:var(--radius);
...
.suggest small{color:#cfc8e8;font-size:12px;letter-spacing:.5px;text-transform:uppercase;font-weight:700}
...
.suggest p{color:#cfc8e8;font-size:14px;position:relative;z-index:1}
