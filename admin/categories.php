...
<div class="app">
  ...
  <main class="content">
    ...
    <div class="topbar">
      <div>
        <h2>Categories</h2>
        <p>View and manage all portfolio categories.</p>
      </div>
    ...
    <div class="card">
      <div class="card-head">
        ...
        <span class="count-pill">
          <?php echo mysqli_num_rows($categories); ?> total
        </span>
      </div>
              ...
              <tr>
                ...
                <td>
                  <?php if (!empty($category['type'])): ?>
                    <span class="type-pill"><?php echo htmlspecialchars($category['type']); ?></span>
                  <?php else: ?>
