          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class="email-cell"><?php echo htmlspecialchars($msg['email'] ?? '—'); ?></td>
                <td class="subject-cell"><?php echo htmlspecialchars($msg['subject'] ?? '—'); ?></td>
            ...
            ?>
              <tr class="empty-row">
                <td colspan="5">
                  <i class="fas fa-envelope-open" style="font-size:24px;color:var(--muted-2);display:block;margin-bottom:8px"></i>
                  No messages found
                </td>
              </tr>
            <?php endif; ?>
