    ...
    if (empty($errors)) {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO profiles (
                ...
                resume_path, resume_downloadable, theme, visibility,
            ...
            ON DUPLICATE KEY UPDATE
                ...
                resume_downloadable = VALUES(resume_downloadable),
                theme = VALUES(theme),
        ...
        header("Location: edit-portfolio.php?saved=1");
        exit;
    }
}
...
<div class="container py-4">
    ...
    <form method="POST" enctype="multipart/form-data" novalidate>
        ...
        <button type="submit" class="btn btn-lg text-white w-100" style="background-color:#3730a3;">
            Save Portfolio
        </button>
    </form>
</div>
